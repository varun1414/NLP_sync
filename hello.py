...
class MyStreamListener(StreamListener):
  ...
  def on_data(self, data):
    if (time.time() - self.start_time) < self.limit:
        ...
        print("neg",negative)
        print("neu",neutral)
        k={"pos":positive,"neg":negative,'neu':neutral,"details":tl,"time":dt,"poshash":[poshash],"neghash":[neghash],"neuhash":[neuhash],"location":[location]}
        print(k)
        s=pd.DataFrame(k)
        print(s)
        try:
